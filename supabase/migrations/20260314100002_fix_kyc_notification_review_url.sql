-- =============================================================================
-- Fix: KYC notification review_url resolving to localhost on hosted env
-- =============================================================================
-- The trigger was using current_setting('app.settings.site_url') which returns
-- the local Supabase site_url (http://localhost:8080) even on hosted envs.
--
-- Fix: Store review_url as a relative path (/admin/kyc). The send-notification
-- edge function resolves it to a full URL using the CLIENT_BASEURL env var,
-- which is correctly configured per environment.
-- =============================================================================
